...
/**
 * CROMO Cryptographic Project for child help:
 * 
 * Auto Liquidity           4%
 * Holders Redistribution   1%
 * Burn                     1%
 * Children's Foundations   3%
 *
 * Total FEEs in purchase and sale: 9%
 *
...
import "./cromo-imports.sol";

/**
 * Thank you for trusting the CROMO project. With your help we can improve the lives of hundreds of children.
 */
abstract contract Tokenomics {
    ...
    string internal constant NAME = "CROMO";
    string internal constant SYMBOL = "CROMO";
    ...
    uint256 internal constant TOTAL_SUPPLY = 21000000 * ZEROES;
    ...
    address internal foundations = 0x313F27cD189FbE81F07AAE0c31D8cdCd35763b8F;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 30, foundations );
